...
HD_PWD='C:/Users/perhat.amanlyyev/UART_2/UART_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_byte_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source four_byte_uart.tcl
