...
HD_PWD='C:/Users/perhat.amanlyyev/UART_2/UART_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log four_byte_uart.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source four_byte_uart.tcl -notrace
